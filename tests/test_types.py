...
from ltls.types import ToolParamMode, Tool, Toolkit, ToolkitSuite, ToolDef, tool_def
...
class TestToolParamMode:
    def test_enum_values(self):
        ...
        assert ToolParamMode.ANTHROPIC == "anthropic"
        assert ToolParamMode.OPENAI == "openai" 
        assert ToolParamMode.MCP == "mcp"
...
class TestTool:
    def test_as_param_openai(self):
        ...
        assert expected["function"]["parameters"] == {"type": "object", "properties": {}}
    ...
    def test_as_param_unsupported(self):
        ...
        with pytest.raises(NotImplementedError):
            tool.as_param(mode=ToolParamMode.MCP)
...
class TestToolkit:
    ...
    def test_as_param(self, mock_as_param, mock_from_function):
        ...
        # Execute
        toolkit = MyToolkit()
        params = toolkit.as_param(mode=ToolParamMode.OPENAI)
...
class TestToolkitSuite:
    ...
    def test_tool_names(self, mock_tool_names):
        ...
        mock_tool_names.__get__ = MagicMock(side_effect=[["test_tool"], ["another_tool"]])
    ...
    def test_as_param(self, mock_as_param, mock_from_function):
        ...
        # Execute
        params = suite.as_param(mode=ToolParamMode.OPENAI)
        ...
        toolkit1.as_param.assert_called_once_with(ToolParamMode.OPENAI)
        toolkit2.as_param.assert_called_once_with(ToolParamMode.OPENAI)
...
class TestToolDef:
    def test_tool_def_decorator(self):
        ...
        assert decorated_function._tool_def.name == "decorated_function"
        assert decorated_function._tool_def.description == "A decorated function"
    ...
    def test_tool_def_uses_docstring_if_no_description(self):
        ...
        assert docstring_function._tool_def.description == "This is the docstring."
    ...
    def test_tool_def_empty_if_no_description_or_docstring(self):
        ...
        assert empty_function._tool_def.description == "" 